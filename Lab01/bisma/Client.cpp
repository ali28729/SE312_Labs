// bisma.cpp : Defines the entry point for the console application.
//
#include <iostream>
#include "stdafx.h"
#include <vector>
...
int _tmain(int argc, _TCHAR* argv[])
{
	...
	while (option != 4){
		...
		case 3:
			//transpose(mat1);
			MatrixLib::Class1::transpose(mat1);
			break;
		case 4:
			MatrixLib::Class1::multiply(a1, a2);
			break;
		default:
			break;
		}
